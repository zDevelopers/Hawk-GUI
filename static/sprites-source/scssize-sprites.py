...
with open(sys.argv[1], "r") as f:
    for line in f:
        ...
        sprites[name] = {"position": position, "width": width, "height": height}

print("$sprite: (")

for sprite_name, sprite_props in sprites.items():
    print(
        f'        "{sprite_name}": ("position": {sprite_props["position"]}, "width": {sprite_props["width"]}, "height": {sprite_props["height"]}),'
    )
